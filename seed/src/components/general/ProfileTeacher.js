            ...
            <div className={classes.profile_body}>
                ...
                <div className={classes.details_profile}>
                    ...
                    <div className={classes.information}>
                        ...
                        <div className={classes.class_master}>
                            ...
                            <p><i className={classes['ti-control-play']}></i> {classs}</p>
                        </div>
                    </div>
                ...
                <div className={classes.introduce_profile}>
                    ...
                    <div className={classes.contact}>
                        ...
                        <p className={classes.profile_content}><i className={classes['ti-mobile']}></i> </p>
                        <p className={classes.profile_content}><i className={classes['ti-email']}></i> {teacher.email}</p>
                    </div>
