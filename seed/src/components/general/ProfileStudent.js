...
const ProfileStudent = props => {
    ...
    useEffect(async () => {
        ...
        if (data.avatar != null) setImage("http://127.0.0.1:8000/static" + data.avatar)
        setStudent(data)
        setIsLoading(false)
    }, [])
    ...
    return <>
        ...
        <div className={classes.container}>
            <div className={classes.left}>
                <div className={classes.heart_icon}><i class={classes["ti-heart"]}></i></div>
            ...
            <div className={classes.right}>
                <div className={classes.close_icon}><i class={classes["ti-close"]}></i></div>
